...
nnoremap <s-i> <c-w>s
nnoremap <s-k> <c-w>s<c-w>j
nnoremap <s-j> <c-w>v
nnoremap <s-l> <c-w>v<c-w>l
...
function! FindWithWildignore(path)
  ...
  for entry in split(&wildignore,",")
    let excluding.= (match(entry,'*/*') > -1 ? " ! -ipath \'" : " ! -iname \'") . entry . "\' "
  endfor
...
nnoremap <leader>, :call SelectaFile(".")<cr>
...
function! SelectaIdentifier()
  ...
  " the cursor
  call SelectaCommand(FindWithWildignore("*"), "-s " . @z, ":e")
endfunction
